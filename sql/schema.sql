...
CREATE TABLE ADMINISTRADOR (
    ...
    CONSTRAINT CK_NOME CHECK (NOME ~ '^[A-Za-z ]{3,50}$')
);
...
CREATE TABLE TIME (
    ...
    CONSTRAINT FK_TIME_ADMINISTRADOR FOREIGN KEY (ADMINISTRADOR_CPF) REFERENCES ADMINISTRADOR(CPF),
    CONSTRAINT FK_TIME_ESPORTE FOREIGN KEY (ESPORTE_NOME) REFERENCES ESPORTE(NOME),
    CONSTRAINT CK_NOME CHECK (NOME ~ '^[A-Za-z0-9_-]{3,50}$'),
...
CREATE TABLE CAMPEONATO (
    ...
    NOME VARCHAR(50) NOT NULL,
    CENTRO_TREINAMENTO_CNPJ CHAR(14) NOT NULL,
    VENCEDOR INTEGER,
    CONSTRAINT PK_CAMPEONATO PRIMARY KEY (ID),
    CONSTRAINT FK_CAMPEONATO_ESPORTE FOREIGN KEY (ESPORTE_NOME) REFERENCES ESPORTE(NOME),
    CONSTRAINT FK_CAMPEONATO_CENTRO_TREINAMENTO FOREIGN KEY (CENTRO_TREINAMENTO_CNPJ) REFERENCES CENTRO_TREINAMENTO(CNPJ),
    CONSTRAINT FK_CAMPEONATO_VENCEDOR FOREIGN KEY (VENCEDOR) REFERENCES TIME(ID),
    CONSTRAINT CK_NOME CHECK (NOME ~ '^[A-Za-z0-9_-]{3,50}$'),
...
CREATE TABLE TIMES_PARTICIPANTES (
    ...
    CONSTRAINT FK_TIMES_PARTICIPANTES_TIME FOREIGN KEY (TIME_ID) REFERENCES TIME(ID),
    CONSTRAINT FK_TIMES_PARTICIPANTES_CAMPEONATO FOREIGN KEY (CAMPEONATO_ID) REFERENCES CAMPEONATO(ID)
);
...
CREATE TABLE ESPECIALIDADE_ARBITROS (
    ...
    CONSTRAINT FK_ESPECIALIDADE_ARBITROS_ARBITRO FOREIGN KEY (ARBITRO_CPF) REFERENCES ARBITRO(CPF),
    CONSTRAINT FK_ESPECIALIDADE_ARBITROS_ESPORTE FOREIGN KEY (ESPORTE_NOME) REFERENCES ESPORTE(NOME),
    CONSTRAINT UN_ARBITRO UNIQUE (ARBITRO_CPF)
);
...
CREATE TABLE PARTIDA (
    ...
    ARBITRO1_CPF CHAR(11),
    ARBITRO2_CPF CHAR(11),
    ARBITRO3_CPF CHAR(11),
    VENCEDOR INTEGER,
    ...
    CONSTRAINT FK_PARTIDA_VENCEDOR FOREIGN KEY (VENCEDOR) REFERENCES TIME(ID),
    CONSTRAINT CK_LOCAL CHECK (LOCAL ~ '^[A-Za-z0-9_-]{3,50}$')
);
...
CREATE TABLE PARTIDA_TIMES (
    ...
    CONSTRAINT FK_PARTIDA_TIMES_TIME FOREIGN KEY (TIME_ID) REFERENCES TIME(ID),
    CONSTRAINT FK_PARTIDA_TIMES_PARTIDA FOREIGN KEY (PARTIDA_ID) REFERENCES PARTIDA(ID),
    CONSTRAINT CK_DESEMPENHO CHECK (DESEMPENHO >= 0 AND DESEMPENHO <= 10)
);
...
CREATE TABLE CONTRATACAO (
    TECNICO_CPF CHAR(11),
    CENTRO_TREINAMENTO_CNPJ CHAR(14),
    DATA_INICIO DATE,
    DATA_FIM DATE,
...
CREATE TABLE PATROCINADOR (
    ...
    CONSTRAINT CK_CNPJ CHECK (CNPJ ~ '^[0-9]{14}$'),
    CONSTRAINT CK_NOME CHECK (NOME ~ '^[A-Za-z ]{3,50}$')
);
-- PATROCINIO COM PATROCINADOR, TIME, DATA INICIO E FIM
CREATE TABLE PATROCINIO (
    PATROCINADOR_CNPJ CHAR(14),
    TIME_ID INTEGER,
    DATA_INICIO DATE,
    DATA_FIM DATE,
